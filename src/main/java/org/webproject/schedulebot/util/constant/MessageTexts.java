...
public class MessageTexts {
    ...
    public static final String WELCOME_MESSAGE = """
        🎉 <b>Добро пожаловать в Task Manager Bot!</b>
        
        Я помогу вам организовать ваши задачи и напомнить о них.
        Используйте <code>/menu</code> или кнопки ниже для навигации.""";
}